...
enum NVGfontEffectType {
    NVG_FONT_EFFECT_NONE = 0,
    NVG_FONT_EFFECT_BLUR = 1,
    NVG_FONT_EFFECT_GROW = 2,
    NVG_FONT_EFFECT_DISTANCE_FIELD = 3,
    NVG_FONT_EFFECT_DISTANCE_FIELD_FAST = 4,
};
...
// to draw powervr_common shapes like rectangles and circles, and lower level step-by-step functions,
// which allow to define a path curve by curve.
//
// NanoVG uses even-odd fill rule to draw the shapes. Solid shapes should have counter clockwise
// winding and holes should have counter clockwise order. To specify winding of a path you can
// call nvgPathWinding(). This is useful especially for the powervr_common shapes, which are drawn CCW.
//
...
// Sets the type of current text blur style.
void nvgFontBlurType(NVGcontext *ctx, int type);
